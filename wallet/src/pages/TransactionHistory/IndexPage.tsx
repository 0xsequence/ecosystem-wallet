...
export const TransactionHistory = () => {
  ...
  if (isLoading) {
    return (
      <div className="isolate flex flex-col w-full max-w-screen-lg grid-cols-2 sm:grid-cols-4 gap-2 mx-auto mt-2 sm:my-18 sm:px-2 p-8 sm:py-0  mb-16">
  ...
  return (
    <div className="isolate flex flex-col w-full max-w-screen-lg grid-cols-2 sm:grid-cols-4 gap-2 mx-auto mt-2 sm:my-18 sm:px-2 p-4 sm:py-0  mb-16">
