      ...
      <div className="flex flex-col flex-1 items-start px-4 py-6 gap-2 text-black">
        ...
        <ul className="flex flex-col gap-4 mt-6 text-md px-4">
          <li className="flex gap-3">
            <span className="flex-shrink-0 bg-seq-green-600 size-6 flex items-center justify-center rounded-full text-white">
              <CheckmarkIcon className="size-4" />
            </span>{' '}
            This will share your wallet address with the dapp
          </li>
          <li className="flex gap-3">
            <span className="flex-shrink-0 bg-seq-red-600 size-6 flex items-center justify-center rounded-full text-white">
